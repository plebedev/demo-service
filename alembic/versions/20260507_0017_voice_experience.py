...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint("experience_id", name="uq_voice_experience_configs_experience_id"),
    )
    op.create_index(
...
def downgrade() -> None:
    op.drop_index("ix_voice_personas_experience_id", table_name="voice_personas")
    op.drop_table("voice_personas")
    op.drop_index(
        "ix_voice_experience_configs_experience_id",
        table_name="voice_experience_configs",
    )
    op.drop_table("voice_experience_configs")
